async function loadRoles() {
    const roleFiles = 
    ["aurial.json", "engineer.json", "investigator.json", "jailor.json", "medic.json", "morphling.json", "mystic.json", "oracle.json", "seer.json", "sheriff.json", "snitch.json", "spy.json", "tracker.json", 
        "trapper.json", "veteran.json", "vigilante.json", "warden.json"]
